...
This area collects policy-level documentation for DocMason.

Current policy priorities:

- English-only public repository materials
- Python-first implementation bias
...
- structured local-only retrieval and trace logging
