"""Tests for the Phase 6 hardening patch workflow and front-controller upgrades."""
...
class PhaseSixHardeningRuntimeTests(unittest.TestCase):
    ...
    def build_seeded_knowledge(
        ...
        *,
        ...
        knowledge = {
            ...
            "confidence": {
                "level": "high",
                "notes_en": "Phase 6 hardening test fixture.",
                "notes_source": "Phase 6 hardening test fixture.",
            },
