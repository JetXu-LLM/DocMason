"""Tests for the Phase 6 follow-on native chat reconciliation and interaction overlay."""
...
class PhaseSixFollowOnRuntimeTests(unittest.TestCase):
    ...
    def build_seeded_knowledge(
        ...
        *,
        ...
        knowledge = {
            ...
            "confidence": {
                "level": "high",
                "notes_en": "Phase 6 follow-on test fixture.",
                "notes_source": "Phase 6 follow-on test fixture.",
            },
    ...
    def seed_interaction_memory(self, workspace: WorkspacePaths) -> str:
        ...
        knowledge = {
            ...
            "summary_en": (
                "The interaction memory captures a latency constraint, concept-style guidance, "
            ...
            "key_points": [
                {
                    "text_en": (
                        "A later user turn added a latency constraint and a concept-style "
                        "requirement."
                    ),
                    "text_source": (
                        "A later user turn added a latency constraint and a concept-style "
            ...
            },
            {
                ...
                "payload": {
                    ...
                    "content": [
                        {
                            "type": "input_text",
                            "text": "How should I draft the architecture review deck for the project sponsor?",
                        }
                    ],
                },
            },
                    ...
                    "content": [
                        {
                            ...
                            "text": (
                                ...
                                "The project sponsor added a latency constraint, and this screenshot "
                    ...
                    "content": [
                        {
                            "type": "output_text",
                            "text": (
                                "The follow-up should emphasize the latency constraint "
    ...
    def seed_prepared_turns(self, workspace: WorkspacePaths, *, thread_id: str) -> None:
        with mock.patch.dict(
            ...
            prepare_ask_turn(
                workspace,
                question="How should I draft the architecture review deck for the project sponsor?",
    ...
    def test_reconcile_native_thread_creates_pending_overlay_and_conversation_turns(self) -> None:
        ...
        overlay_retrieval = retrieve_corpus(
            workspace,
            query="latency constraint screenshot concept style",
            top=3,
            graph_hops=1,
            document_types=None,
            source_ids=None,
    ...
    def test_prepare_ask_turn_recommends_sync_when_pending_interaction_is_relevant(self) -> None:
        ...
        with (
            ...
            turn = prepare_ask_turn(
                workspace,
                question="How should I handle the latency constraint from the screenshot?",
                semantic_analysis=self.semantic_analysis(
    ...
    def test_legacy_interaction_memories_get_semantic_defaults_backfilled(self) -> None:
        ...
        loaded_contexts = retrieve_corpus(
            workspace,
            query="latency constraint concept style",
            top=3,
            graph_hops=1,
            document_types=None,
            source_ids=None,
