"""Tests for the DocMason Phase 6 natural intent routing and conversation logging."""
...
class PhaseSixRuntimeTests(unittest.TestCase):
    """Cover ask routing, conversation linkage, and review candidates."""
    ...
    def build_seeded_knowledge(
        ...
        *,
        ...
        knowledge = {
            ...
            "confidence": {
                "level": "high",
                "notes_en": "Phase 6 test fixture.",
                "notes_source": "Phase 6 test fixture.",
            },
