"""Tests for the Phase 6b3 tiered text-source support."""
...
class PhaseSixB3TextRuntimeTests(unittest.TestCase):
    ...
    def seed_agent_outputs(self, source_dir: Path) -> None:
        ...
        knowledge = {
            ...
            "confidence": {
                "level": "medium",
                "notes_en": "Phase 6b3 text-source fixture.",
                "notes_source": "Phase 6b3 text-source fixture.",
            },
    ...
    def test_ask_and_trace_surface_text_locator_metadata(self) -> None:
        ...
        with mock.patch.dict(os.environ, {"CODEX_THREAD_ID": "thread-text-phase-6b3"}, clear=False):
            turn = prepare_ask_turn(
                workspace,
