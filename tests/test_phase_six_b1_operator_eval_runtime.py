"""Tests for the Phase 6b1 hidden operator eval loop and four-state answer contract."""
...
class PhaseSixB1OperatorEvalRuntimeTests(unittest.TestCase):
        ...
        *,
        ...
        write_json(
            source_dir / "knowledge.json",
            {
                ...
                "confidence": {
                    "level": "high",
                    "notes_en": "Phase 6b1 test fixture.",
                    "notes_source": "Phase 6b1 test fixture.",
                },
    ...
    def write_broad_eval_assets(self, workspace: WorkspacePaths) -> None:
        ...
        write_json(
            ...
            {
                "schema_version": 1,
                "rubric_id": "phase-6b1-test-rubric",
                "title": "Phase 6b1 test rubric",
                "trial_count": 3,
        ...
        write_json(
            ...
            {
                "schema_version": 1,
                "suite_id": "phase-6b1-broad-test-suite",
                "title": "Phase 6b1 Broad Test Suite",
        ...
        write_json(
            benchmark_dir / "judge-trials.json",
            {
                ...
                "judge_profile": {
                    ...
                    "agent_name": "codex",
                    "model_name": "gpt-5",
                    "workflow_id": "phase-6b1-test-judge",
                    "trial_count": 3,
                },
                "trials_by_case": {},
            },
    ...
    def test_operator_eval_run_suite_and_freeze_baseline(self) -> None:
        ...
        self.write_operator_request(
            ...
            suite="broad",
            target_ids=[],
            run_label="Phase 6b1 broad suite",
        )
