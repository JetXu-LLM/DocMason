"""Tests for the DocMason Phase 3 sync, validation, and publish workflow."""
...
class PhaseThreeRuntimeTests(unittest.TestCase):
    """Cover staged sync, validation, and publication behavior."""
    ...
    def create_pptx(self, path: Path) -> None:
        ...
        slide.placeholders[1].text = "Hello from Phase 3."
    ...
    def test_sync_requires_office_renderer_for_office_sources(self) -> None:
        ...
        with mock.patch("docmason.knowledge.find_soffice_binary", return_value=None):
