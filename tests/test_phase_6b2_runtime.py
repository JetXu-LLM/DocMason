"""Tests for the Phase 6b2 user-native source reference resolution layer."""
...
class PhaseSixB2RuntimeTests(unittest.TestCase):
    ...
    def build_seeded_knowledge(
        ...
        *,
        ...
        knowledge = {
            ...
            "confidence": {
                "level": "high",
                "notes_en": "Phase 6b2 test fixture.",
                "notes_source": "Phase 6b2 test fixture.",
            },
    ...
    def test_exact_source_reference_hard_filters_retrieval(self) -> None:
        ...
        report = retrieve_knowledge(
            query="Architecture Strategy Deck page 1 operating model",
            top=5,
            graph_hops=2,
    ...
    def test_exact_unit_locator_prefers_targeted_page(self) -> None:
        ...
        report = retrieve_knowledge(
            query="Architecture Strategy Deck page 2 visual detail",
            top=3,
            graph_hops=1,
            include_renders=True,
            paths=workspace,
    ...
    def test_exact_source_with_soft_locator_still_filters_to_source_only(self) -> None:
        ...
        report = retrieve_knowledge(
            query="Architecture Strategy Deck page 9",
            top=5,
            graph_hops=2,
            include_renders=False,
            paths=workspace,
    ...
    def test_approximate_resolved_unit_is_reranked_first_within_source(self) -> None:
        ...
        retrieval_data = {
            "manifest": {"source_signature": "phase-6b2-test"},
            "source_records": [
                {
                    "source_id": "deck-1",
    ...
    def test_prepare_turn_and_answer_trace_keep_reference_resolution(self) -> None:
        ...
        turn = prepare_ask_turn(
            workspace,
            question="Architecture Strategy Deck page 2 visual detail",
            semantic_analysis={
                "question_class": "answer",
                "question_domain": "workspace-corpus",
                "route_reason": "Phase 6b2 propagation test.",
            },
        )
