<div align="center">
  ...
  <p><sub>Already paying for ChatGPT? <a href="https://openai.com/codex"><strong>Codex for macOS</strong></a> is included in your plan. Open DocMason inside Codex to turn that unused capacity into a local Second Brain. <a href="https://youtu.be/Sq3a5qxsLwM"><b>See it cross-reference complex office files</b></a> (board decks, spreadsheets, and legal memos) in real time. Put your AI to work on your actual private documents, not just chat prompts. Zero-to-working in minutes.</sub></p>
</div>
